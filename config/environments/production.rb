...
Rails.application.routes.default_url_options[:host] = 'www.forumrelated.com'
CzardomEvents::Engine.routes.default_url_options[:host] = 'www.forumrelated.com'
Forem::Engine.routes.default_url_options[:host] = 'www.forumrelated.com'
